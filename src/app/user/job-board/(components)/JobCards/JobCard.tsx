...
export default function JobCard() {
  ...
  return (
    <Card className="max-w-sm bg-[#9574e2] border-none hover:cursor-pointer hover:scale-105 transition-all hover:border-2 hover:border-white ">
      <CardContent className="p-6">
        <div className="flex justify-between items-start mb-4">
          <span className="text-sm text-black">{job.date}</span>
