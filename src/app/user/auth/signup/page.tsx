          ...
          <div className='flex justify-around items-center gap-5 '>
            <div className='flex flex-col gap-5'>
              <div className='flex flex-col gap-2 items-center justify-start overflow-hidden'>
                <h1 className='text-7xl  dark:text-[var(--primary)] font-bold font-Josefin_Sans'>Welcome</h1>
                ...
                <p className='font-Josefin_Sans font-semibold mt-6  dark:text-[var(--primary)]'>Login with Other Platform</p>
