...
export function NavBar() {
  ...
  return (
    <div className="relative m-3  border-b-1 border-gray-500 p-5">
                    ...
                    <BorderBeam />
                        <DockIcon>
                            <Link href="/">
                                ...
                                <RippleButton rippleColor="#ADD8E6" className="font-Josefin_Sans">DashBoard</RippleButton>
                                </div>
                            </Link>
                        </DockIcon>
                        <DockIcon>
                            <Link href="/">
                                ...
                                <RippleButton rippleColor="#ADD8E6">WorkSpaces</RippleButton>
                                </div>
                            </Link>
                        </DockIcon>
                        <DockIcon>
